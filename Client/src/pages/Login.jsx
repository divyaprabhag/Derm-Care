...
//       <div className="bg-gradient-to-r from-gray-700 to-gray-900 p-10 rounded-lg w-full max-w-md">
//         <h1 className="text-3xl text-center text-white font-bold mb-6">Login</h1>
